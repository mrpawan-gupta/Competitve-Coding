...
void ____solveTestCases(){
    ...
    // cout << "Case #" << Tc << ": "; Tc++;
            long long n;
            cin >> n;
            long long ____vector[n];
            long long ____vectorSum = 0;
            F0R(__idx,n){
                cin >> ____vector[__idx];
                ____vectorSum+=____vector[__idx];
            }
            long long cnt = ____vectorSum / (n+1);
            F0R(__idx,n){
                cout << ____vector[__idx] - cnt << " ";
            }
            cout << endl;
}
