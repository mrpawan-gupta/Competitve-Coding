...
void ____solveTestCases(){
    ...
    int n, m; cin >> n >> m;
        ...
        for(int i=0; i < m; i++){
                ...
                cout << "? " << out << endl; cout.flush(); out[i] = '0';
