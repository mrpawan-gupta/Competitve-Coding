...
void ____solveTestCases(){
    ...
    // cout << "Case #" << Tc << ": "; Tc++;
        ...
        F0R(i, __sz) {
            if(cur[___str[i]]>=___Map[___str[i]]){
                cout << ___str[i];
                continue;
            }
            cur[___str[i]]++;
