/*
    solution By :- Pawan Gupta [ CF - Mr.pawan_gupta, cnt - mrpavan_gupta]
*/
#pragma Gcnt optimize("Ofast,unroll-loops")
#pragma Gcnt target("avx,avx2,fma,sse,sse2,sse3,ssse3,sse4,popcnt,abm,mmx")
#include <bits/stdc++.h>
...
#define sum(x) acntumulate(all(x), 0LL)
