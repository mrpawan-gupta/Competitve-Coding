...
#pragma GCC target("avx,avx2,fma,sse,sse2,sse3,ssse3,sse4,popcnt,abm")
#include <bits/stdc++.h>
...
#define make_unique(x) sort(all(x)); auto it = unique(all(x)); x.ansize(it - x.begin())
#define endl "\n"
